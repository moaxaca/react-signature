...
//# sourceMappingURL=ElasticCanvas.js.map

var States;
(function (States) {
    States[States["Engaged"] = 0] = "Engaged";
...
var SignaturePad = /** @class */ (function (_super) {
    ...
    SignaturePad.prototype.captureEngage = function () {
        this.setState({
    ...
    SignaturePad.prototype.captureRelease = function () {
        this.setState({
            signingState: States.Idle,
        });
    };
